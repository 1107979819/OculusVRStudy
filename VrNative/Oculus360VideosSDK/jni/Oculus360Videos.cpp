...
long Java_com_oculus_oculus360videossdk_MainActivity_nativeSetAppInterface(
	JNIEnv *jni, jclass clazz, jobject activity )
{
	...
	return ( new Oculus360Videos() )->SetActivity( jni, clazz, activity );
}
...
//============================================================================================
void Oculus360Videos::OneTimeInit( const char * launchIntent )
{
	...
	VrLocale::GetString( app->GetOvrMobile(), videosLabel, videosLabel, localizedAppName );
...
void Oculus360Videos::Command( const char * msg )
{
	...
	else if ( MatchesHead( "startError", msg ) )
	{
		...
		String message;
		VrLocale::GetString( app->GetOvrMobile(), "@string/playback_failed", "@string/playback_failed", message );
...
void Oculus360Videos::OnVideoActivated( OvrMetaDatum * videoData )
{
