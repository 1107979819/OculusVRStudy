...
long Java_com_oculusvr_vrscene_MainActivity_nativeSetAppInterface(
		JNIEnv * jni, jclass clazz, jobject activity )
{
	LOG( "game SetAppInterface");
	return (new VrScene())->SetActivity( jni, clazz, activity );
}
...
void VrScene::NewIntent( const char * intent )
{
